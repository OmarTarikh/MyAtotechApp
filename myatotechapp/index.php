    ...
    <div class="bg-home" style="background-color: #BF3131;">
        ...
        <nav class="navbar navbar-expand-lg container-fluid sticky-top pt-2 mb-5" style="background-color: #BF3131; position: fixed;">
            <div class="container">
                <a class="navbar-brand d-flex align-items-center gap-2" style="text-decoration: none;" href="#">
                    <img src="img/logo.png" alt="logo" class="navbar-logo" style="width: 50px;">
        ...
        <!--home-page-start-->
            <div class="home-page container pt-5" id="home-page">
                ...
                <svg class="position-absolute bottom-0 mb-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 353"><path fill="#fff" fill-opacity="1" d="M0,160L48,165.3C96,171,192,181,288,186.7C384,192,480,192,576,181.3C672,171,768,149,864,144C960,139,1056,149,1152,149.3C1248,149,1344,139,1392,133.3L1440,128L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path></svg>
    </div>
        <!--home-page-end-->
        <!-- clients-page -->
